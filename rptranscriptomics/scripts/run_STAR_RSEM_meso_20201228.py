...
parser.add_argument('--SR_script', default="/home/adelexu/research/rptranscriptomics/rptranscriptomics/scripts/STAR_RSEM_20201228.sh")
...
# for each sample, make output subdirectory and call STAR_RSEM script
for smp in sample:
