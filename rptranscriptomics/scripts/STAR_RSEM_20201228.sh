...
# - (2020-12-28) outFilterMismatchNoverReadLmax 0.01 instead of 0.04
# use version of STAR, samtools, RSEM, and R in conda_rptranscriptomics instead of explicitly loading a version
...
STARparCommon=" --genomeDir $STARgenomeDir  --readFilesIn $read1 $read2   --outSAMunmapped Within --outFilterType BySJout \
 ...
 --outFilterMismatchNoverReadLmax 0.01   --alignIntronMin 20   --alignIntronMax 1000000   --alignMatesGapMax 1000000   \
...
source activate conda_rptranscriptomics
